...
We create three candidate CDR's using three different learning techniques: AdaBoost, Classification Trees, and Logistic Regression. Each model has their own strengths and weaknesses in terms of interpretability and predictability.



For clarity, we also include Bin's models.
...
```{r roc-curves, fig.width=6.3, fig.cap="ROC curves for the three candidate models. The black dot represents the results from Leonard et al.", out.width='85%'}
...
```{r roc-curves2, fig.width=7.3, eval=FALSE,fig.cap="ROC curves for the three candidate models.", out.width='85%'}
