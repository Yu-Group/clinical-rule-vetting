...
date: \textbf{Acknowledgments:} Michael Boyle, Chandan Singh, Omer Ronen, Bin Yu
header-includes:
   - \usepackage{float}
   - \usepackage{bbm}
   - \usepackage{graphicx}
