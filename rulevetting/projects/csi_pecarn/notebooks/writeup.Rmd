...
```{r accuracy-rates, out.width="85%", fig.width=9.5, fig.height=6, fig.cap="Sensitivity and specificity rates for candidate models and baseline model. Accuracy rates are assessed at each model's optimal hyperparameter value."}
