...
```{r, echo=FALSE}
kable(py$mrules, caption = "Top 5 maximal model rules in order of importance")
```
...
*Insert comparison with Andrej's rules above in the demonstration section*

*Insert a few paragraphs about Random Forests and their results (maybe refer to notebook or something to see more specifics)*
