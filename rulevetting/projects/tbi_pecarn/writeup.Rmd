...
*Insert here a summary about the two data sets that we are considering - summary statistics of the data that can easily be reproduced elsewhere. We have two data sets that we will be considering. The first, is what we describe as the simple data set and consist of just the features that are mentioned.*
...
knitr::include_graphics(c("/Users/marko/rule-vetting/rulevetting/projects/tbi_pecarn/notebooks/figs/<2 Years Old Tree Feature Importances.png", "/Users/marko/rule-vetting/rulevetting/projects/tbi_pecarn/notebooks/figs/=>2 Years Old Tree Feature Importances.png"))
```
...
```{r, out.width = "300px"}
knitr::include_graphics("/Users/marko/rule-vetting/rulevetting/projects/tbi_pecarn/notebooks/figs/dt_roc.png")
```
