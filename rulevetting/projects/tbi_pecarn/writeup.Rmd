...
<<<<<<< HEAD
  + Judgement Call [`Seiz`]: Drop missing *SeizLen*, impute missing *Seiz* from *SeizLen*, drop missing *Seiz*, and ignore *SeizOccur* column
    + Perturbation 1: Drop missing *SeizLen* and *Seiz*, exclude *SeizOccur* column
=======
...
However, it is non-robust when we perturb the data and the greedy method does not guarantee a good result.
...
versus performing an unneeded CT test. In terms of importance, hemotympamnum was by far the most important predictor,
...
of our possible perturbations for our judgement calls and, using the best classifier,
...
perturbations and obtain a test dataset (32 test datasets in total), and for each
set, we evaluate the sensitivity and specificity using our best rulefit model.
...
responses was the presence of a large frontal hematoma, an above-the-clavicle injury on the frontal part of the scalp, 
