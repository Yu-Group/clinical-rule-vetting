...
judgement call procedure, we present two models:
...
- Stability of performance across data perturbations
  - perturb the data by selecting some of the judgement calls, but only perturb test data and see how the model fares (the classification errors)
  
  judgement calls to turn on/off: `SFxPalp`, `Seiz` (change from recoding to not recoding), `ActNorm` recoding (change it up), `Vomit` (either union and impute or not)
